...
if __name__ == '__main__':
    ...
    def job_runner(bash_list, worker_profile, existing_clusters):
        ...
        if worker_profile in prior_clusters:
            scheduler_address = prior_clusters[worker_profile]
        ...
        return client.gather(stdout_string_futures)
    ...
    cluster = LocalCluster(n_workers=1, memory_limit='200 MB', processes=True)
    ...
    existing_clients.set({'small_cluster': small_SLURM_cluster.scheduler_address,
                          'large_cluster': large_SLURM_cluster.scheduler_address
                          })
